...
let s:bgblack   = g:dracula#palette.bgblack
...
call s:h('DraculaBoundary', s:comment, s:bgdarker)
...
call s:h('Normal', s:fg, g:dracula_colorterm || has('gui_running') ? s:bgblack : s:none )
...
" C
hi! link CTagsDefinedName DraculaOrange
hi! link CTagsMember DraculaPurple
hi! link CTagsGlobalVariable DraculaCyan

" Java
hi! link CTagsMethod DraculaGreen
hi! link CTagsClass DraculaCyan
hi! link CTagsEnumeratorName DraculaCyan
hi! link CTagsEnumerationValue DraculaOrange
hi! link CTagsField DraculaPurple
